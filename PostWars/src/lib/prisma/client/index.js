...
const config = {
	generator: {
		...
		output: {
			value: '/Users/michaelslaughter/PostWarsV2/my-app/my-app/my-app/src/lib/prisma/client',
			fromEnvVar: null
		},
		config: {
			engineType: 'library'
		...
		previewFeatures: [],
		sourceFilePath: '/Users/michaelslaughter/PostWarsV2/my-app/my-app/my-app/prisma/schema.prisma',
		isCustomOutput: true
	},
	relativeEnvPaths: {
		rootEnvPath: '../../../../.env',
	...
	inlineSchemaHash: '9365943f2f2e43804d3f78630d4dda042714b2645e0ecc83f360086e31588997',
	copyEngine: false
};
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
	const alternativePaths = ['src/lib/prisma/client', 'lib/prisma/client'];
